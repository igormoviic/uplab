 <footer class="site-footer footer-v1">
                <div class="col-full">
                                ...
                                <div class="contact-payment-wrap">
                                    <div class="footer-contact-info">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <span class="call-us-title">Dúvidas</span>
                                                <span class="call-us-text">Entre em cotato com nossa central de atendimento através do SAC</span>
                                    ...
                                    <div class="footer-payment-info">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h5 class="footer-payment-info-title">Seu pagamento seguro</h5>
                    ...
                    <div class="site-info">
                        <div class="col-full">
                            <div class="copyright">Copyright &copy; 2019 <a href="home-v1.html">Igor Oliveira</a></div>
                            <!-- .copyright -->
                            <div class="credit">Feito com
                                <i class="fa fa-heart"></i> para você.</div>
                            <!-- .credit -->
                        </div>
                        <!-- .col-full -->
                    </div>
